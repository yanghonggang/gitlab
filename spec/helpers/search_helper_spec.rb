  ...
  describe '#highlight_and_truncate_issuable' do
    ...
    context 'when description present' do
      ...
      where(:description, :expected) do
        'test'                                                                 | '<span class="search-term-highlight">test</span>'
        '<span style="color: blue;">this test should not be blue</span>'       | '<span>this <span class="search-term-highlight">test</span> should not be blue</span>'
        '<a href="#" onclick="alert(\'XSS\')">Click Me test</a>'               | '<a href="#">Click Me <span class="search-term-highlight">test</span></a>'
        '<script type="text/javascript">alert(\'Another XSS\');</script> test' | ' <span class="search-term-highlight">test</span>'
