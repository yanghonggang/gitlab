  ...
  module Latest
    class ApplicationClassProxy < Elasticsearch::Model::Proxy::ClassMethodsProxy
      ...
      def project_ids_query(user, project_ids, public_and_internal_projects, features = nil, no_join_project = false)
        ...
        conditions = pick_projects_by_membership(scoped_project_ids, user, features, no_join_project)
      ...
      # granted here.
      def pick_projects_by_membership(project_ids, user, features = nil, no_join_project)
